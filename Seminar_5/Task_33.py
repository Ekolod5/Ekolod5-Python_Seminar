"""Задача N33. Хакер Василий получил доступ к классному журналу и хочет заменить 
...
# marks = list(map(str, marks))   #аналог 12 строки
...
# строку и заменяем в ней максимальные элементы на минимальные. Замена str(max_mark) на str(min_mark)
